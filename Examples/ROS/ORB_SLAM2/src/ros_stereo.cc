...
public:
    ImageGrabber(ORB_SLAM2::System* pSLAM, ORB_SLAM2::SlamDataPub* pSlamPub):
        mpSLAM(pSLAM), mpSlamDataPub(pSlamPub){}
...
int main(int argc, char **argv)
{
    ...
    string left_cam_topic = fsSettings["Camera.left_topic"];
    string right_cam_topic = fsSettings["Camera.right_topic"];

    message_filters::Subscriber<sensor_msgs::Image> left_sub(nh, left_cam_topic, 1);
    message_filters::Subscriber<sensor_msgs::Image> right_sub(nh, right_cam_topic, 1);
